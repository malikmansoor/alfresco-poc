 ...
 */
package com.alfresco.community.poc.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.alfresco.community.poc.DemoComponent");
